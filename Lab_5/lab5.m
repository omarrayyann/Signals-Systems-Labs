...
% |H(0.1pi)|*cos(0.1pin+phase(H(0.1pi))). So it can be thought of as a
% being multiplied with a magnitude and phase shifted.
...
% Having the frequency response H(w), y(n) can be written as
% |H(0.3pi)|*cos(0.1pin+phase(H(0.3pi))). So it can be thought of as being
% hte product of a magnitude and have a phase shift.
...
% p1 = 0.8 ej0.2 π, p2 = 0.8 e−j0.2 π, p3 = 0.7, z1 = −1, z2 = ej0.6 π, z3
% = e−j0.6 π 
